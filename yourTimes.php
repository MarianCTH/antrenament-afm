        ...
        <section class="form-section">
            <div class="table-responsive">
                <table class="table table-striped">
                    ...
                    <tbody>
                        <?php foreach ($userTimes as $index => $entry): ?>
                            <tr>
                        ...
                        <?php endforeach; ?>
                        <?php if (empty($userTimes)): ?>
                            <tr>
                                <td colspan="4" class="text-center">Nu aveți încă timpi înregistrați.</td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
